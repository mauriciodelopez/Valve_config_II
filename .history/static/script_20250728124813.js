...
document.getElementById('valveConfiguratorForm').addEventListener('submit', async function(event) {
    ...
    console.log("Form Values:", {
        ...
        sealSurfaceMaterial, connectionType, nominalDiameter, fluidType, aiPrompt
    });
    ...
    // Add a new section for Guy-Lussac-like pressure/temperature relationship logic
    // This is a simplified check for potentially problematic P/T combinations, not a strict application of Guy-Lussac's Law.
    // It aims to highlight conditions that might require specialized valve considerations.
    if (temperature > 100 && pressure < 1) { // Example: High temperature with very low pressure (potential for flashing/vacuum)
        ...
        // This doesn't necessarily make it 'unsuitable' but adds a strong warning.
    } else if (temperature < 0 && pressure > 50) { // Example: Very low temperature with high pressure (potential for cryogenic or high-pressure gas)
